...
const generateExpenseDetail = (user_id) => {
    return useForm({
...
const selectedGroupMember = ref(null);
const setSelectedGroupMember = (groupMember) => {
    selectedGroupMember.value = groupMember;
    setIsDialogOpen(false);
    payerFormArray.value = [generateExpenseDetail(selectedGroupMember.value.user_id)];
};
        ...
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:px-8 dark:text-gray-200">
            ...
            <div class="flex flex-col gap-2">
                <div class="flex flex-col gap-1">
                    ...
                    <button
                        class="btn btn-outline max-w-80 dark:border-0 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-700"
                        @click="setDialogMode('selectGroupMember')"
                    >
                        <div class="flex w-full flex-row items-center gap-2">
                            <ProfilePhotoImage
                                v-if="selectedGroupMember?.user?.profile_photo_url"
                            ...
                            <DialogPanel class="pointer-events-auto w-screen">
                                ...
                                >
                                    ...
                                    <div class="flex-1 overflow-y-auto pb-4">
                                        ...
                                        />
                                        <div class="flex flex-col gap-2" v-if="dialogMode === 'selectGroupMember'">
                                            <template v-for="m in currentGroup.group_members">
                                                <button
                                                    type="button"
                                                    class="flex flex-row items-center justify-between gap-2 px-6 py-2 hover:bg-gray-100"
                                                ...
                                                >
                                                    ...
                                                    <CheckCircleIcon
                                                        ...
                                                        v-if="selectedGroupMember?.user_id === m.user.id"
                                                    />
                                                </button>
                                            </template>
                                        </div>
