    ...
    <AppLayout>
        <form class="flex h-full flex-col">
                ...
                >
                    <div class="flex items-start justify-between space-x-3">
                        <div class="space-y-1">
                            ...
                            >
                                Create a group to split payments with invited
                                members.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        v-if="
                                            group?.img_url && !group?.img_path
                                        "
                                        >Image populated from Image URL (filled
                                        in below)</span
                                    >
                                </div>
                                ...
                                <div class="flex flex-col">
                                    <div
                                        class="flex justify-center text-sm leading-6"
                                    >
                                        <label
                                            for="group_photo"
            ...
            <div
                ...
                :class="[isLightMode && 'border-t border-gray-200']"
            >
