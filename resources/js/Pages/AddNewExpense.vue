...
const isPaidBySelectionShown = ref(false);
const isSelectSplitModeShown = ref(true);
</script>

<template>
    <AppLayout title="Home">
        <div class="top-0 z-10 flex w-full flex-row items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
            <span class="text-lg font-medium">Add an expense</span>
            <button
                type="button"
        ...
        <div class="mx-auto flex max-w-7xl flex-col gap-12 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-1">
                <span>With <span class="font-medium">you</span> and: </span>
                <button class="btn btn-outline w-full" @click="isDialogOpen = true">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-row gap-2">
                    ...
                    <input type="text" placeholder="Enter a description" class="input input-bordered w-full" />
                </div>
            ...
            <div class="flex flex-col gap-5">
                <div class="flex flex-row items-center justify-center gap-2">
                    ...
                    <button
                        ...
                        @click="isPaidBySelectionShown = !isPaidBySelectionShown"
                    >
                        <span>you</span>
                    </button>
                    <span>and split</span>
                    <button
                        type="button"
                        class="btn btn-outline"
                        @click="isSelectSplitModeShown = !isSelectSplitModeShown"
                    >
                        <span>equally</span>
                    </button>
                </div>
                <TransitionRoot as="template" :show="isPaidBySelectionShown">
                    <TransitionChild
                        ...
                        leave-to="opacity-0"
                    >
                        <div class="flex flex-col rounded-xl bg-gray-50 transition-opacity">
                            <div class="flex flex-row items-center justify-between gap-2 border-b-[1px] p-4">
                                <label class="label flex cursor-pointer flex-row items-center gap-4 p-0">
                                    <input type="checkbox" class="checkbox" />
                                    <span class="label-text">Select All</span>
                                </label>
                                <span class="text-sm">Total to pay: US$ 20.00</span>
                            </div>
                            <div
                                class="flex flex-row flex-wrap items-center justify-between gap-3 p-4 hover:bg-gray-200"
                            >
                                ...
                                <input
                                    ...
                                    min="0.00"
                                    placeholder="0.00"
                                    class="input input-sm input-bordered max-w-40 [appearance:textfield] disabled:bg-gray-300 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                                />
                            </div>
                            <div class="flex flex-row justify-end border-t-[1px] p-4">
                                <span class="text-sm">Remaining: US$ 20.00</span>
                            </div>
                        </div>
                    </TransitionChild>
                </TransitionRoot>
                ...
                <TransitionRoot as="template" :show="isSelectSplitModeShown">
                    ...
                    >
                        <div class="flex flex-col rounded-xl bg-gray-50 transition-opacity">
                            <div role="tablist" class="tabs-boxed tabs bg-gray-50 p-4">
                                <a role="tab" class="tab tab-active">
                                    <Bars2Icon class="h-5 w-5" />
                                </a>
                                <a role="tab" class="tab text-wrap bg-gray-200">
                                    <span class="text-xl font-extrabold">1.23</span>
                                </a>
                            </div>
                            <div class="flex flex-row items-center justify-between gap-2 border-b-[1px] p-4">
                                <label class="label flex cursor-pointer flex-row items-center gap-4 p-0">
                                ...
                                <span class="text-sm">Total to split: US$ 20.00</span>
                            </div>
                            ...
                            <div class="flex flex-row justify-end border-t-[1px] p-4">
                                <span class="text-sm">Split equally: US $20.00/ person</span>
                            </div>
                        </div>
                    </TransitionChild>
                </TransitionRoot>
                    ...
                    <div class="pointer-events-none fixed inset-y-0 flex max-w-full pt-60">
                        ...
                        >
                            <DialogPanel class="pointer-events-auto w-screen">
                                <div class="flex h-full flex-col rounded-t-2xl bg-white shadow-xl">
                                    <div class="p-6">
