...
<template>
    <div class="isolate min-h-full">
        ...
        <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
            ...
            <p class="mt-4 text-white sm:mt-6">Sorry, we couldn't find the page you're looking for.</p>
            <div class="mt-10 flex justify-center">
                <Link :href="route('home')" class="text-sm font-semibold leading-7 text-white"
