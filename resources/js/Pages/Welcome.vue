...
<template>
    ...
    >
        <div v-if="canLogin" class="z-10 p-6 text-end sm:fixed sm:end-0 sm:top-0">
            <Link
        ...
        <div class="mx-auto max-w-7xl p-6 lg:p-8">
            ...
            <div class="mt-16 flex justify-center px-6 sm:items-center sm:justify-between">
                ...
                <div class="text-center text-sm text-gray-500 sm:ms-0 sm:text-end dark:text-gray-400">
